...
public final class NEuclidianDistance implements NDistanceMeasurer {

  private static final NEuclidianDistance DISTANCE = new NEuclidianDistance();
   ...
   */
  public static NEuclidianDistance get() {
    return DISTANCE;
  }
