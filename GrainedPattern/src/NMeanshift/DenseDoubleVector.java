 ...
 */
public final class DenseDoubleVector implements NDoubleVector {
   ...
   */
  public DenseDoubleVector(NDoubleVector vec) {
  ...
  @Override
  public NDoubleVector apply(NDoubleVectorFunction func) {
  ...
  @Override
  public NDoubleVector apply(NDoubleVector other, NDoubleDoubleVectorFunction func) {
  ...
  @Override
  public final NDoubleVector add(NDoubleVector v) {
  ...
  @Override
  public final NDoubleVector add(double scalar) {
    NDoubleVector newv = new DenseDoubleVector(this.getLength());
  ...
  @Override
  public final NDoubleVector subtract(NDoubleVector v) {
    NDoubleVector newv = new DenseDoubleVector(v.getLength());
    for (int i = 0; i < v.getLength(); i++) {
      newv.set(i, this.get(i) - v.get(i));
    }
    return newv;
  ...
  @Override
  public final NDoubleVector subtract(double v) {
  ...
  @Override
  public final NDoubleVector subtractFrom(double v) {
    DenseDoubleVector newv = new DenseDoubleVector(vector.length);
    for (int i = 0; i < vector.length; i++) {
  ...
  @Override
  public NDoubleVector multiply(double scalar) {
    NDoubleVector v = new DenseDoubleVector(this.getLength());
    for (int i = 0; i < v.getLength(); i++) {
  ...
  @Override
  public NDoubleVector multiply(NDoubleVector vector) {
    NDoubleVector v = new DenseDoubleVector(this.getLength());
    for (int i = 0; i < v.getLength(); i++) {
  ...
  @Override
  public NDoubleVector divide(double scalar) {
    if (scalar == 0d) {
  ...
  @Override
  public NDoubleVector divideFrom(double scalar) {
    NDoubleVector v = new DenseDoubleVector(this.getLength());
    for (int i = 0; i < v.getLength(); i++) {
      if (this.get(i) != 0.0d) {
  ...
  @Override
  public NDoubleVector divideFrom(NDoubleVector vector) {
    NDoubleVector v = new DenseDoubleVector(this.getLength());
    for (int i = 0; i < v.getLength(); i++) {
      if (this.get(i) != 0.0d) {
  ...
  @Override
  public NDoubleVector divide(NDoubleVector vector) {
    NDoubleVector v = new DenseDoubleVector(this.getLength());
    for (int i = 0; i < v.getLength(); i++) {
  ...
  @Override
  public NDoubleVector pow(double x) {
  ...
  @Override
  public NDoubleVector sqrt() {
    NDoubleVector v = new DenseDoubleVector(getLength());
    for (int i = 0; i < v.getLength(); i++) {
  ...
  @Override
  public double dot(NDoubleVector s) {
  ...
  @Override
  public NDoubleVector slice(int length) {
    return slice(0, length);
  }

  @Override
  public NDoubleVector slice(int start, int end) {
    NDoubleVector nv = new DenseDoubleVector(end - start);
    int index = 0;
  ...
  @Override
  public NDoubleVector sliceByLength(int start, int length) {
    NDoubleVector nv = new DenseDoubleVector(length);
    int index = start;
