 ...
 * 
 */
public interface NDoubleVector {
  ...
  /**
   * Apply a given {@link NDoubleVectorFunction} to this vector and return a new
   * one.
   * 
  ...
  /**
   * Apply a given {@link NDoubleDoubleVectorFunction} to this vector and the
  ...
  /**
   * Adds the given {@link NDoubleVector} to this vector.
   * 
   * @param v the other vector.
   * @return a new vector with the sum of both vectors at each element index.
   */
  public NDoubleVector add(NDoubleVector v);
   ...
   */
  public NDoubleVector add(double scalar);

  /**
   * Subtracts this vector by the given {@link NDoubleVector}.
   * 
   * @param v the other vector.
   * @return a new vector with the difference of both vectors.
   */
  public NDoubleVector subtract(NDoubleVector v);
   ...
   * @return a new vector with the result at each element index.
   */
  public NDoubleVector subtract(double scalar);
   ...
   * @return a new vector with the result at each element index.
   */
  public NDoubleVector subtractFrom(double scalar);
  ...
  /**
   * Multiplies the given {@link NDoubleVector} with this vector.
   * 
   ...
   */
  public NDoubleVector slice(int end);
