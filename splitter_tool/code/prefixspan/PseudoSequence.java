...
public class PseudoSequence {
	...
	public PseudoSequence(PseudoSequence sequence, int indexItemset, int indexItem, double prevtimestamp){
	...
	public PseudoSequence(PseudoSequence sequence, int indexItemset, int indexItem, int lastItemset, int lastItem, double prevtimestamp){
		this.sequence = sequence.sequence;
		this.firstItemset = indexItemset + sequence.firstItemset;
		if(this.firstItemset == sequence.firstItemset){
			this.firstItem = indexItem + sequence.firstItem;
	...
	public  PseudoSequence(long decalageTemps, Sequence sequence, int indexItemset, int indexItem, double prevtimestamp){
...
//		}
	...
	public void setPrevtimestamp(double prevtimestamp) {
		this.prevtimestamp = prevtimestamp;
	}
	...
	public void setPrevitemset(List<Itemset> previtemset) {
		this.previtemset = previtemset;
	}
	
	public int getSizeOfPrevitemset(){
		return this.previtemset.size();
	}
}